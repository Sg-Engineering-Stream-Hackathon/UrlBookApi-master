...
namespace WebApiCatalog
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            options.UseNpgsql(Configuration.GetConnectionString("urlBookContext"), x => x.MigrationsAssembly("UrlBookApi")));
            ...
            /*                             Functional SERVICE                                                    */
            /*---------------------------------------------------------------------------------------------------*/
            services.AddTransient<IFunctionalService, FunctionalService.FunctionalService>();
